...
export function ThinkingPhilosophy() {
  ...
  return (
    <section ref={sectionRef} id="thinking" className="py-[clamp(4.5rem,8vw,8.5rem)] border-t border-line relative z-10">
      <div className="max-w-[1240px] mx-auto px-[clamp(1rem,5vw,4rem)]">
        <div className="eyebrow">05 — How I Think</div>

        <p
          ref={statementRef}
          className="mt-6 max-w-[900px] font-serif italic font-normal text-[clamp(1.35rem,3.2vw,2.4rem)] leading-[1.32]"
        >
          {statementText.split(" ").map((word, i) => (
            <span key={i} className="fade-word opacity-25 transition-opacity inline-block mr-[0.25em]">
              {word}
            </span>
          ))}
        </p>
        ...
        <div className="mt-12 sm:mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          <div className="p-5 sm:p-6 rounded-2xl bg-bg-raise/60 border border-line/70 hover:border-accent transition-colors">
            <div className="font-mono text-accent text-xs font-semibold">01</div>
            <h4 className="font-display font-medium text-base sm:text-lg mt-2.5 text-paper">Verify before you trust</h4>
            <p className="mt-2.5 text-stone font-light text-xs sm:text-sm leading-relaxed">
          ...
          <div className="p-5 sm:p-6 rounded-2xl bg-bg-raise/60 border border-line/70 hover:border-accent transition-colors">
            ...
            <h4 className="font-display font-medium text-base sm:text-lg mt-2.5 text-paper">Latency is a feature</h4>
            <p className="mt-2.5 text-stone font-light text-xs sm:text-sm leading-relaxed">
          ...
          <div className="p-5 sm:p-6 rounded-2xl bg-bg-raise/60 border border-line/70 hover:border-accent transition-colors">
            ...
            <h4 className="font-display font-medium text-base sm:text-lg mt-2.5 text-paper">Ship the whole stack</h4>
            <p className="mt-2.5 text-stone font-light text-xs sm:text-sm leading-relaxed">
