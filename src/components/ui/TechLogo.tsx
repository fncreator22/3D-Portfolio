...
export function TechLogo({ name, className = "w-4 h-4", showName = true }: TechLogoProps) {
    ...
    if (norm.includes("python")) {
      return (
        <svg viewBox="0 0 24 24" fill="none" className={className}>
          <path d="M11.9 2C6.7 2 7.1 4.3 7.1 4.3l.01 2.3h4.9v.7H5.2S2 7 2 12.2c0 5.3 2.8 5.1 2.8 5.1h1.7v-2.4s-.1-2.8 2.8-2.8h4.8s2.7.1 2.7-2.6V4.7s.4-2.7-4.9-2.7zm-2.7 1.6a1 1 0 110 2 1 1 0 010-2z" fill="#3776AB"/>
  ...
  return (
    <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl bg-bg-raise/90 border border-line/80 hover:border-accent/60 hover:shadow-[0_0_15px_rgba(193,99,59,0.2)] transition-all font-mono text-xs text-paper/90 group">
